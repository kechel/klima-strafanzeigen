...
exports.FontFaceDeclarations = void 0;
...
class FontFaceDeclarations {
    ...
    create(name, fontFamily, fontPitch) {
        ...
        fontFace = new style_1.FontFace(name, fontFamily, fontPitch);
...
exports.FontFaceDeclarations = FontFaceDeclarations;
